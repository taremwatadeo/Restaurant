...
# create a new restaurant named pizza palace
myFirstRestaurant = Restaurant(name='pizza Palace')
session.add(myFirstRestaurant)
session.commit()

# create menuitem and add menuitem to myFirstRestaurant
myFirstMenu = MenuItem(name='cheese pizza', course='Entree', price='4.5',
